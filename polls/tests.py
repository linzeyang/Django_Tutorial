...
class PollMethodTests(TestCase):
    ...
    def test_was_published_recently_with_recnet_poll(self):
        """
...
class PollViewTests(TestCase):
    ...
    def test_detail_view_with_a_future_poll(self):
        ...
        """
        future_poll = create_poll(question="Future poll.", days=1)
    ...
    def test_detail_view_with_a_past_poll(self):
        ...
        the poll's question.
        """
        past_poll = create_poll(question="Past poll.", days=-1)
